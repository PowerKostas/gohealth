...
data class Settings(
    ...
    // Comma-separated string of notified achievements ("Wanderer, Foot Soldier" ...)
    @ColumnInfo(name = "notified_achievements", defaultValue = "") val notifiedAchievements: String = ""
)
